...
class FormMapper:
    ...
    def map_cost_calculations(form: RenovationForm) -> Dict[str, Any]:
        ...
        try:
            ...
            cost_variables = {
                # Main option costs for Fast Pris section
                "arbetskostnad_main": labor_cost,
                ...
                # Option 1 costs
                "arbetskostnad_option1": labor_cost_option1,
                "materialkostnad_option1": material_cost_option1,
                ...
                # Option 2 costs
                "arbetskostnad_option2": labor_cost_option2,
                "materialkostnad_option2": material_cost_option2,
                ...
                "arbetskostnad_main_str": f"{labor_cost:,.2f} kr",
